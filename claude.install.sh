...
DOWNLOAD_DIR="$(rpm -E '%{_sharedstatedir}')/.claude/downloads"
...
# They insist on putting the binary in the home dir. Bad claude.ai
mv "$HOME/.local/bin/claude" "$(rpm -E '%{_bindir}')"
